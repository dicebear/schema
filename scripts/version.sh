...
# Go encodes the major version in the module path (`.../v2`), and the module
...
# scripts/version.sh in the dicebear/styles repo.
promote_changelog() {
...
echo
echo "Syncing README CDN URLs..."
bash "$ROOT/scripts/sync-readme.sh"
